...
```console
dotnet fsi release/smoke-test-package.fsx --configuration Release
```

The command packs `Dotnet.WorkspaceExplorer`, checks its identity and essential .NET tool layout, installs
