...
let configuration =
    ...
    | _ -> fail "Usage: dotnet fsi release/smoke-test-package.fsx --configuration Release"
...
let inspectPackage packagePath packageId version =
    ...
    for path in
        [ "readme.md"
          ...
          "tools/net10.0/any/dotnet.workspaceexplorer.dll"
          "tools/net10.0/any/dotnet.workspaceexplorer.deps.json"
          "tools/net10.0/any/dotnet.workspaceexplorer.runtimeconfig.json" ] do
...
let packageId = "Dotnet.WorkspaceExplorer"
...
try
    ...
    let project =
        Path.Combine(repositoryRoot, "src", "WorkspaceExplorer", "Dotnet.WorkspaceExplorer.fsproj")
    ...
    require
        ...
        "The installed package did not provide dotnet-workspace-explorer."
